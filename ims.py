...
#Instructions
print("Welcome to Inventory Manamgement System")
print()
print("A-Add an item")
print("R-Remove an item")
print("E-Edit specifications of an item")
...
while(c!= "q" or c!= "Q"):
    ...
    elif(c=="P" or c=="p"):#Purchase a item
        print()
        p_no = int(input("Enter item number: "))
        if(p_no in unit_price):
            if(flag==1):
...
print()
print("Thank you for using Inventory Manamgement System")
